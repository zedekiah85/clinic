...
#this function serves as a conditional homepage,
# directing authenticated users to their post-login destination and presenting a default page 
#(such as a login or landing page) to unauthenticated users.
...
#for showing signup/login button for admin(by plasma)
...
#for showing signup/login button for doctor(by plasma)
@login_required(login_url='doctorlogin')
def doctorclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'clinic/doctorclick.html')


#for showing signup/login button for patient(by plasma)
...
def doctor_signup_view(request):
    ...
    return render(request,'clinic/doctorsignup.html',context=mydict)
...
#-----------for checking user is doctor , patient or admin(by plasma)
def is_admin(user):
...
def afterlogin_view(request):
    if is_admin(request.user):
        ...
        if accountapproval:
            ...
            return render(request,'clinic/doctor_wait_for_approval.html')
...
def admin_doctor_view(request):
    return render(request,'clinic/admin_doctor.html')

@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
def admin_view_doctor_view(request):
    doctors=models.Doctor.objects.all().filter(status=True)
    return render(request,'clinic/admin_view_doctor.html',{'doctors':doctors})



@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
def delete_doctor_from_clinic_view(request,pk):
...
def update_doctor_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and doctorForm.is_valid():
            ...
            doctor.save()
            return redirect('admin-view-doctor')
    return render(request,'clinic/admin_update_doctor.html',context=mydict)
...
def admin_add_doctor_view(request):
    ...
    return render(request,'clinic/admin_add_doctor.html',context=mydict)
...
def admin_approve_doctor_view(request):
    ...
    return render(request,'clinic/admin_approve_doctor.html',{'doctors':doctors})
...
def admin_view_doctor_specialisation_view(request):
    doctors=models.Doctor.objects.all().filter(status=True)
    return render(request,'clinic/admin_view_doctor_specialisation.html',{'doctors':doctors})
...
def doctor_dashboard_view(request):
    ...
    return render(request,'clinic/doctor_dashboard.html',context=mydict)
...
def doctor_patient_view(request):
    ...
    return render(request,'clinic/doctor_patient.html',context=mydict)
...
def doctor_view_patient_view(request):
    ...
    doctor=models.Doctor.objects.get(user_id=request.user.id) #for profile picture of doctor in sidebar
    return render(request,'clinic/doctor_view_patient.html',{'patients':patients,'doctor':doctor})
...
def doctor_view_discharge_patient_view(request):
    ...
    doctor=models.Doctor.objects.get(user_id=request.user.id) #for profile picture of doctor in sidebar
    return render(request,'clinic/doctor_view_discharge_patient.html',{'dischargedpatients':dischargedpatients,'doctor':doctor})
...
def doctor_appointment_view(request):
    doctor=models.Doctor.objects.get(user_id=request.user.id) #for profile picture of doctor in sidebar
    return render(request,'clinic/doctor_appointment.html',{'doctor':doctor})
...
def doctor_view_appointment_view(request):
    ...
    appointments=zip(appointments,patients)
    return render(request,'clinic/doctor_view_appointment.html',{'appointments':appointments,'doctor':doctor})
...
def doctor_delete_appointment_view(request):
    ...
    patients=models.Patient.objects.all().filter(status=True,user_id__in=patientid)
    appointments=zip(appointments,patients)
    return render(request,'clinic/doctor_delete_appointment.html',{'appointments':appointments,'doctor':doctor})
...
def patient_view_doctor_view(request):
    doctors=models.Doctor.objects.all().filter(status=True)
    patient=models.Patient.objects.get(user_id=request.user.id) #for profile picture of patient in sidebar
    return render(request,'clinic/patient_view_doctor.html',{'patient':patient,'doctors':doctors})
...
def ourteam_view(request):
    return render(request,'clinic/ourteam.html')
