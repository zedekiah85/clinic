...
Developed By : plasma kumar
facebook : fb.com/plasma.luv
...
urlpatterns = [
    ...
    path('delete-doctor-from-clinic/<int:pk>', views.delete_doctor_from_clinic_view,name='delete-doctor-from-clinic'),
